var Z80 = function(){
  ...
  //Shift left 
  this.SLAg = function(register){
	  this._flags.carry = this._registers[register] > 0x7F;
	  this._registers[register] = (this._registers[register] << 1) & 0xFF;
  ...
  this.SRAg = function(register){
	  this._flags.carry = (this._registers[register] & 0x01) == 0x01;
	  this._registers[register] = (this._registers[register] & 0x80) | (this._registers[register] >> 1);
  ...
  this._CBInstructionMap = [
	...
	//  CB20
	this.SLAg.bind(this, 'b'),
	this.SLAg.bind(this, 'c'),
	this.SLAg.bind(this, 'd'),
	this.SLAg.bind(this, 'e'),
	this.SLAg.bind(this, 'h'),
	this.SLAg.bind(this, 'l'),
	this.SLAHL,
	this.SLAg.bind(this, 'a'),
	this.SRAg.bind(this, 'b'),
	this.SRAg.bind(this, 'c'),
	this.SRAg.bind(this, 'd'),
	this.SRAg.bind(this, 'e'),
	...
	// CB40
	this.BITg.bind(this, 0x01, 'b'),
	this.BITg.bind(this, 0x01, 'c'),
	this.BITg.bind(this, 0x01, 'd'),
	this.BITg.bind(this, 0x01, 'e'),
	this.BITg.bind(this, 0x01, 'h'),
	this.BITg.bind(this, 0x01, 'l'),
	this.BITHLg.bind(this, 0x01),
	this.BITg.bind(this, 0x01, 'a'),
	this.BITg.bind(this, 0x02, 'b'),
	this.BITg.bind(this, 0x02, 'c'),
	this.BITg.bind(this, 0x02, 'd'),
	this.BITg.bind(this, 0x02, 'e'),
	this.BITg.bind(this, 0x02, 'h'),
	this.BITg.bind(this, 0x02, 'l'),
	this.BITHLg.bind(this, 0x02),
	this.BITg.bind(this, 0x02, 'a'),
	
	// CB50
	this.BITg.bind(this, 0x04, 'b'),
	this.BITg.bind(this, 0x04, 'c'),
	this.BITg.bind(this, 0x04, 'd'),
	this.BITg.bind(this, 0x04, 'e'),
	this.BITg.bind(this, 0x04, 'h'),
	this.BITg.bind(this, 0x04, 'l'),
	this.BITHLg.bind(this, 0x04),
	this.BITg.bind(this, 0x04, 'a'),
	this.BITg.bind(this, 0x08, 'b'),
	this.BITg.bind(this, 0x08, 'c'),
	this.BITg.bind(this, 0x08, 'd'),
	this.BITg.bind(this, 0x08, 'e'),
	...
	// CBA0
	this.RESg.bind(this, 0xEF, 'b'),
	this.RESg.bind(this, 0xEF, 'c'),
	this.RESg.bind(this, 0xEF, 'd'),
	this.RESg.bind(this, 0xEF, 'e'),
	this.RESg.bind(this, 0xEF, 'h'),
	this.RESg.bind(this, 0xEF, 'l'),
	this.RESHLg.bind(this, 0xEF),
	this.RESg.bind(this, 0xEF, 'a'),
	this.RESg.bind(this, 0xDF, 'b'),
	this.RESg.bind(this, 0xDF, 'c'),
	this.RESg.bind(this, 0xDF, 'd'),
	this.RESg.bind(this, 0xDF, 'e'),
	this.RESg.bind(this, 0xDF, 'h'),
	this.RESg.bind(this, 0xDF, 'l'),
	this.RESHLg.bind(this, 0xDF),
	this.RESg.bind(this, 0xDF, 'a'),
	
	// CBB0
	this.RESg.bind(this, 0xBF, 'b'),
	this.RESg.bind(this, 0xBF, 'c'),
	this.RESg.bind(this, 0xBF, 'd'),
	this.RESg.bind(this, 0xBF, 'e'),
	this.RESg.bind(this, 0xBF, 'h'),
	this.RESg.bind(this, 0xBF, 'l'),
	this.RESHLg.bind(this, 0xBF),
	this.RESg.bind(this, 0xBF, 'a'),
	this.RESg.bind(this, 0x7F, 'b'),
	this.RESg.bind(this, 0x7F, 'c'),
	this.RESg.bind(this, 0x7F, 'd'),
	this.RESg.bind(this, 0x7F, 'e'),
	...
	// CBD0
	this.SETg.bind(this, 0x04, 'b'),
	this.SETg.bind(this, 0x04, 'c'),
	this.SETg.bind(this, 0x04, 'd'),
	this.SETg.bind(this, 0x04, 'e'),
	this.SETg.bind(this, 0x04, 'h'),
	this.SETg.bind(this, 0x04, 'l'),
	this.SETHLg.bind(this, 0x04),
	this.SETg.bind(this, 0x04, 'a'),
	this.SETg.bind(this, 0x08, 'b'),
	this.SETg.bind(this, 0x08, 'c'),
	this.SETg.bind(this, 0x08, 'd'),
	this.SETg.bind(this, 0x08, 'e'),
